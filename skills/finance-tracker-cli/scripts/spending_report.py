...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Generate spending summary from finance-tracker database.")
    p.add_argument("--db", default="./data/finance.db", help="Path to SQLite database")
    p.add_argument("--days", type=int, default=30, help="Lookback days")
    p.add_argument("--top", type=int, default=10, help="Top N merchants")
    return p.parse_args()
